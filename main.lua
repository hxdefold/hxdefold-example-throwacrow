...
__defold_support_Init.init = function(exports) 
  ...
  exports.Block_init = function(_self) 
    script:init(_self);
  end;
  exports.Block_on_message = function(self1,message_id,message,_) 
    script:on_message(self1, message_id, message, _);
  end;
  local script1 = Wind.new();
  exports.Wind_on_message = function(self2,message_id1,message1,_1) 
    script1:on_message(self2, message_id1, message1, _1);
  end;
  local script2 = Throwacrow.new();
  exports.Throwacrow_init = function(self3) 
    script2:init(self3);
  end;
  exports.Throwacrow_final_ = function(_2) 
    script2:final_(_2);
  end;
  exports.Throwacrow_update = function(self4,_3) 
    script2:update(self4, _3);
  end;
  exports.Throwacrow_on_input = function(self5,action_id,action) 
    do return script2:on_input(self5, action_id, action) end;
  end;
  local script3 = CustomRender.new();
  exports.CustomRender_init = function(self6) 
    script3:init(self6);
  end;
  exports.CustomRender_update = function(self7,_4) 
    script3:update(self7, _4);
  end;
  exports.CustomRender_on_message = function(self8,message_id2,message2,_5) 
    script3:on_message(self8, message_id2, message2, _5);
  end;
  local script4 = Camera.new();
  exports.Camera_init = function(self9) 
    script4:init(self9);
  end;
  exports.Camera_final_ = function(_6) 
    script4:final_(_6);
  end;
  exports.Camera_update = function(self10,_7) 
    script4:update(self10, _7);
  end;
  local script5 = Debris.new();
  exports.Debris_init = function(self11) 
    script5:init(self11);
  end;
  local script6 = Parallax.new();
  exports.Parallax_init = function(self12) 
    script6:init(self12);
  end;
  exports.Parallax_update = function(self13,_8) 
    script6:update(self13, _8);
  end;
end
